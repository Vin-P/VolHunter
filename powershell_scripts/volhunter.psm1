    ...
    Process {
        try {
            ...
            $exeBlock = {
                ...
                switch ($sysInfo) {
                    # Windows 10 Ver 10586/14393/15063+/none x86/64 Not optimal If statements but easier to read#
                    {$_ -like "*Windows 10*"} {
                        ...
                        elseif (($osVersi.Build -ge 17763) -and ($osVersi.Build -lt 18362)) {$volProfile = "Win10x"+$architecture+"_17763"}
                        elseif ($OSVersi.Build -ge 18362) {$volProfile = "Win10x"+$architecture+"_18362"}
